...
const serviceprovider_route = require('./route/ServiceProvider/serviceprovider_routes'); // this is for serviceprovider route
...
// if request come from "localhost:3000/serviceprovider", then it gose to serviceprovider_route
app.use("/serviceprovider" , serviceprovider_route);
