...
const detailed_eventplan_view_controller = require('../../controller/Manager/detailed_eventplan_view_controller');
const add_expense_controller = require('../../controller/Manager/add_expense_controller');
const ingredients_list_view_controller = require('../../controller/Manager/ingredients_list_view_controller');
...
mn_route.post("/add_decoration",add_decoration_controller.ADD_decoration);
mn_route.get("/view_event",event_view_controller.VIEW_event);
mn_route.get("/view_detailedevent",detailed_eventplan_view_controller.VIEW_detailedevent);
mn_route.post("/add_expense",add_expense_controller.ADD_expense);
mn_route.get("/view_ingredientlist",ingredients_list_view_controller.VIEW_ingredientlist);
